...
Advancing through Theatria's Player Ranks unlocks powerful commands to enhance gameplay. If you choose to support the server with a donation, you can access the [Support Ranks](commands.md#support-ranks). This page organizes commands by rank. For a quick reference, see our alphabetical [All Commands](all-commands.md).
...
* **/worth**: Displays the [sell value](economy/sell-hand.md) of items
  * **Subcommands**:
