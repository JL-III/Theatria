...
For help navigating these areas, refer to the [**Getting Around**](../../getting-around/) section of the wiki.
...
<figure><img src="../../../.gitbook/assets/image (11).png" alt="x blocks left to break"><figcaption></figcaption></figure>
...
**Note:** The shrine will only accept items after the action phase is completed. For help navigating, check out the [**Getting Around**](../../getting-around/) section of the wiki.
