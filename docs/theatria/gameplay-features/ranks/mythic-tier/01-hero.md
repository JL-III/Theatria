...
* [View the list of new Hero commands here.](../../all-commands/commands.md#hero)
...
* Gain access to unique kits with cooldown periods:
  ...
  * **`/kit spawner5`**: Cooldown of **1 month**, allowing you to win random [spawners](../../spawners.md) that you can place in the Mining world.
