...
- [📜 Rules & Policies](rules-policies/rules.md)
  ...
  - [🛠️ Claim Maintenance and Expiration](rules-policies/claim-maintenance-expiration.md)
  - [🔓 Banned Player Lock Removals](rules-policies/banned-player-lock-removals.md)
  - [🐞 Bug & Exploit Reward System](rules-policies/bug-exploit-rewards.md)
...
- [🎉 Events & Challenges](events-challenges/README.md)
  ...
  - [🌟 The Oracle's Blessing](events-challenges/oracle-blessing.md)
    ...
    - [⛏️ Quartz Hoarders Honor](events-challenges/quartz-hoarders-honor.md)
